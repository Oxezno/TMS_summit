...
namespace TMS.Controllers
{
    public class DocusignController : Controller
    {
        ...
        private string INTEGRATOR_KEY = "96d76571-6348-44ec-83a1-deaadbf6d781";
        public ActionResult SendDocumentforSign()
        {
            return View();
        }
        [HttpPost]
        public ActionResult SendDocumentforSign(TMS.Models.Recipient recipient, HttpPostedFileBase UploadDocument)
        {
